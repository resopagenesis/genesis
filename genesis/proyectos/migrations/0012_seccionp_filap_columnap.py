    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degradado', models.CharField(default='top', max_length=6)),
                ('borde', models.BooleanField(default=False)),
                ('seccion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyectos.seccionp')),
            ],
        ),
        migrations.CreateModel(
            name='ColumnaP',
            fields=[
                ...
                ('fila', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proyectos.filap')),
            ],
        ),
    ]

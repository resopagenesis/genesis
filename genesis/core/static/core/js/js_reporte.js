...
function enviar(){
    ...
    window.location.href = 'http://127.0.0.1:8000/modelos/reporte_lista/?criterio=&json=' + JSON.stringify(json_envio) + '&nuevo=' + nuevo + '&proyecto_id=' + id_proyecto + '&modelo_id=' + id_modelo  + '&id=' + id;
}
